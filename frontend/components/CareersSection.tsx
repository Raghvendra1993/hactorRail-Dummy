      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-24 items-start">
          <div>
            ...
            <a
              href="#contact"
              className="px-8 py-4 bg-brand-yellow text-black text-sm font-bold uppercase tracking-wide hover:bg-brand-orange transition-colors inline-block"
            >
              View Open Positions
            </a>
          </div>
          ...
          <div className="space-y-4">
            <p className="text-xs text-white/30 uppercase tracking-widest mb-6">Open Positions</p>
            {roles.map((role) => (
              <div
                key={role.title}
              ...
              >
                <div>
                  <h3 className="font-display font-bold text-white group-hover:text-brand-yellow transition-colors">
                    {role.title}
                  </h3>
                ...
                <span className="text-white/30 group-hover:text-brand-yellow group-hover:translate-x-1 transition-all duration-300 text-lg">
                  →
                </span>
              </div>
            ))}
